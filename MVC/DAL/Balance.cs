...
namespace LEANJU.DAL
{
	...
	public partial class Balance
	{
		...
		public bool Exists(string id)
		{
			...
			strSql.Append("select count(1) from Balance");
		...
		public bool Delete(string id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Balance ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.NVarChar,20)			};
			parameters[0].Value = id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,password,balance ");
			strSql.Append(" FROM Balance ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Balance T ");
